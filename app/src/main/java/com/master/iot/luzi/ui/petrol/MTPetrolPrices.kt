...
class MTPetrolPricesLoading(val title: Int = R.string.loading_data_title) : MTPetrolPrices()
class MTPetrolPricesReady(val prices: List<MTPetrolPricesData>) : MTPetrolPrices()
